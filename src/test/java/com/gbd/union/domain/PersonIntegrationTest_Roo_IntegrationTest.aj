...
privileged aspect PersonIntegrationTest_Roo_IntegrationTest {
    ...
    public void PersonIntegrationTest.testCountPeople() {
        ...
        long count = com.gbd.union.domain.Person.countPeople();
    ...
    public void PersonIntegrationTest.testFindPerson() {
        com.gbd.union.domain.Person obj = dod.getRandomPerson();
        ...
        obj = com.gbd.union.domain.Person.findPerson(id);
    ...
    public void PersonIntegrationTest.testFindAllPeople() {
        ...
        java.util.List<com.gbd.union.domain.Person> result = com.gbd.union.domain.Person.findAllPeople();
    ...
    public void PersonIntegrationTest.testFindPersonEntries() {
        ...
        java.util.List<com.gbd.union.domain.Person> result = com.gbd.union.domain.Person.findPersonEntries(0, (int) count);
    ...
    public void PersonIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyPerson(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.gbd.union.domain.Person merged = (com.gbd.union.domain.Person) obj.merge();
        obj.flush();
    ...
    public void PersonIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Person' failed to initialize correctly", dod.getRandomPerson());
        com.gbd.union.domain.Person obj = dod.getNewTransientPerson(Integer.MAX_VALUE);
    ...
    public void PersonIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Person' with identifier '" + id + "'", com.gbd.union.domain.Person.findPerson(id));
    }
